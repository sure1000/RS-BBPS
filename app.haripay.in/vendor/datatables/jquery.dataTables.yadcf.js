...
(function ($, window, document, undefined) {
	var yadcf = (function () {
		...
		function addRangeNumberFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char) {
			...
			$(filter_selector_string).html("<div id=\"yadcf-filter-wrapper-inner-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter-wrapper-inner" + " -" + table_selector_jq_friendly + "-" + column_number + "\"></div>");
		...
		function addRangeDateFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
			...
			$(filter_selector_string).html("<div id=\"yadcf-filter-wrapper-inner-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter-wrapper-inner " + innerWrapperAdditionalClass + "\"></div>");
			filter_selector_string += " div.yadcf-filter-wrapper-inner";
		...
		function addRangeNumberSliderFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, min_val, max_val, ignore_char) {
			...
			if (isFinite(min_val) && isFinite(max_val) && isFinite(min_state_val) && isFinite(max_state_val)) {
				...
				$(filter_selector_string).html("<div id=\"yadcf-filter-wrapper-inner-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-number-slider-filter-wrapper-inner" + " -" + table_selector_jq_friendly + "-" + column_number + "\"></div>");
					...
					if ($filter_selector.length === 1) {
						...
						if (filter_container_id === undefined && columnObj.filter_container_selector === undefined) {
							...
							if ($("#yadcf-filter-wrapper-" + generateTableSelectorJQFriendlyNew(columnObj.filter_container_selector)).length === 0) {
								$(columnObj.filter_container_selector).html("<div id=\"yadcf-filter-wrapper-" + generateTableSelectorJQFriendlyNew(columnObj.filter_container_selector) + "\"></div>");
							}
						...
						if (columnObj.filter_type === "select" || columnObj.filter_type === 'custom_func') {
							...
							//add a wrapper to hold both filter and reset button
							$(filter_selector_string).html("<div id=\"yadcf-filter-wrapper-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter-wrapper\"></div>");
							filter_selector_string += " div.yadcf-filter-wrapper";
	...
	*/
		...
		function appendFiltersMultipleTables(tablesArray, tablesSelectors, colObjDummy) {
			...
			//add a wrapper to hold both filter and reset button
			$(filter_selector_string).html("<div id=\"yadcf-filter-wrapper-" + table_selector_jq_friendly + '-' + column_number_str + "\" class=\"yadcf-filter-wrapper\"></div>");
			filter_selector_string += " div.yadcf-filter-wrapper";
