...
if ($_POST['water_updte'] == '1') {
	$o1 = new wallet;
	$o1->amount = $_POST['water_amount'];
	$o1->mobile_number = $_POST['water_mobile'];
	$o1->circle_name = $_POST['water_state'];
	$o1->provider_id = $_POST['water_provider'];
	// $o1->state = $_POST['water_state'];
	$o1->last_date=$_POST['water_last_date'];
	$o1->account_number=$_POST['water_account_number'];
	$o1->circle_id="0";
	//$stv = $_POST['special'];
