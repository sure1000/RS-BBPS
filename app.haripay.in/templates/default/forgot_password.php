<div id="forgot_password" style="display:none;">
	<form class="user" name="fp" id="fp" method="post" action="forgot_password.php" onsubmit="return false;">
		...
		<div class="form-group">
			<input type="text" class="form-control form-control-user" id="forgot_email" name="forgot_email" placeholder="Enter Email Address..." required="required" />
		</div>
		<div class="form-group">
		...
		<div class="text-center">
            <a class="small" href="#" onclick="show_login('1')">Back to Login</a>
             <div class="text-center">
                                               <a class="small" href="privacy.php">Privacy Policy</a>
                                            </div>
        </div>
