            ...
            <div class="row">
                ...
                <div class="text-left col align-self-center">
                    <a class="navbar-brand" href="#">
                        <h5 class="mb-0">Recharge Pending</h5>
                    </a>
                </div>
            ...
            <div class="container h-100">
                <div class="row h-100">
                    <div class="col-12 col-md-6 col-lg-4 align-self-center text-center my-3 mx-auto">
                        <div class="icon icon-120 bg-warning-light text-warning rounded-circle mb-3">
                            <i class="material-icons display-4">cached</i>
                        </div>
                        <h2 class="display-2">Pending</h2>
