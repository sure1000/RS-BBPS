							...
							<form id="prepaid"  class="form">
								...
								<div class="input_container">
									...
									<div class="input_wrap">
											...
											<input type="date" class="input" value="<?php echo date('Y-m-d');?>" id="date_from" style="height: 40px;width: 49%;font-weight: bold;font-size: 12px;padding-left: 10px;padding: 20px;">

						

											<input type="date" class="input" value="<?php echo date('Y-m-d');?>" id="date_to" style="height: 40px;width: 49%;font-weight: bold;font-size: 12px;padding-left: 10px;padding: 20px;">
