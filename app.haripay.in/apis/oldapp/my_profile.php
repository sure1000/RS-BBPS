...
<div class="form">
	...
	<div class="form_wrap">
		<form id="loginform" method="post" class="form">
			...
			<div class="input_wrap">
					<div class="input_field">
					<input type="button" id="Update" value="Update"  class="input_submit" style="margin-top: 10%;font-size: 16px;width: 100%;border-top-right-radius: 0px;border-bottom-right-radius: 0px;">
				</div>
