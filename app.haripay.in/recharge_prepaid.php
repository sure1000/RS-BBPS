...
if ($_POST['prepaid_updte'] == '1') {



    $o1 = new wallet;
    $o1->amount = $_POST['prepaid_amount'];
    $o1->total_amount =$_POST['prepaid_amount'];
    $o1->mobile_number = $_POST['prepaid_number'];
    $o1->provider_id = $_POST['prepaid_provider'];
    $o1->circle_name = $_POST['prepaid_circle'];
    $o1->circle_id = "0";
    if ($o->plan_id > 0) {
