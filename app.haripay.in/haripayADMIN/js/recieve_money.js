...
$('#phone_email').change(function(){
    ...
    $('#credit_wallet_1').prop('disabled',true);
    $('#credit_wallet_1').prop('checked',false);
    $('#credit_wallet_2').prop('disabled',true);
    $('#credit_wallet_2').prop('checked',false);
    $('#update_credit').prop('disabled',true);
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if(result['error'] == 1){
                ...
                $('#credit_wallet_1').prop('disabled',false);
                $('#credit_wallet_2').prop('disabled',false);
                //$('#update_credit').prop('disabled',false);
...
$('#credit_wallet_2').click(function(){
    $('#update_credit').prop('disabled',false);
});
$('#credit_wallet_1').click(function(){
    $('#update_credit').prop('disabled',true);
});
