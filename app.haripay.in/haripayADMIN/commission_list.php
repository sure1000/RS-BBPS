...
if (isset($_SESSION['search'])) {
	...
	if (isset($_SESSION['search']['ip_address'])) {
		$trigger_ip_address = "ip_address = '" . $_SESSION['search']['ip_address'] . "'";
	}
}

$triggers = $trigger_provider_type . " and " . $trigger_provider_id . " and " . $trigger_transaction_type . " and " . $trigger_status . " and " . $trigger_from_date . " and " . $trigger_to_date . " and " . $trigger_search_val . " and " . $trigger_opid . " and " . $trigger_api_id . " and " . $trigger_user_name . " and " . $trigger_ip_address;
...
$sql_transactions = "Select * from wallet where $triggers order by wallet_id limit $row ,$length";
...
if ($row == 0) {
	...
	/*$sql_turnover = "Select transaction_type from wallet where  $triggers and wallet_id < " . $res_transactions[0]['wallet_id'] . " group by transaction_type";
