...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><?php if ($o1->site_info_id > 0) { ?> Edit <?php } else { ?> Add <?php } ?> Website Details</h6>
        </div>
        <div class="card-body">
            <form name="whitelabel2" id="whitelabel2" action="add_site_detailes.php" method="post" enctype="multipart/form-data" >
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" name="app_link" value="<?= $o1->app_link; ?>" id="app_link" class="form-control" placeholder="Web url" />
						<input type="hidden" name="app_link_old" value="<?= $o1->app_link; ?>" id="app_link_old"/>
                    </div>
                    <div class="col-md-4">
                        <label>Upload Logo</label>
                        <input type="file" name="logo" value="<?= $o1->logo; ?>"id="logo" class="form-control"  placeholder="Web url" />
						<input type="hidden" name="logo_old" value="<?= $o1->logo; ?>" id="logo_old"/>
                        <?php if($o1->logo){ ?>
