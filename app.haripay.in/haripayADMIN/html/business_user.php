...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            <h1 class="h3 mb-2 text-gray-800">Turnover User Wise</h1>
        </div>
    </div>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form name="search_txn" id="search_txn2" method="post"  action="business_user.php" >
                <div class="row">
                    <div class="col-md-2">
                        <label>From</label>
                        <input type="date" class="form-control" name="from_date" id="from_date" placeholder="From Date" value="<?=$_POST['from_date'];?>" />
                    </div>
                    <div class="col-md-2">
                        <label>To</label>
                        <input type="date" class="form-control" name="to_date" id="to_date" placeholder="To Date" value="<?=$_POST['to_date'];?>"  />
                    </div>
                    <div class="col-md-3">
                        <label>User Name</label>
                        <input type="text" name="user_name" id="user_name" placeholder="Name / Username" value="<?=$_POST['user_name'];?>" class="form-control" />
                    </div>
                    <div class="col-md-2">
                        <label>&nbsp;</label>
...
$total_success_amt = $total_success_amt + $data[$i]['success']['total_amount'] + $data[$i]['success1']['total_amount'] + $data[$i]['success2']['total_amount'];
