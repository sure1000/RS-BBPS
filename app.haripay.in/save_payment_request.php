        ...
        if ($o3->status == "Pending") {
            ...
            if ($o3->status == "Transferred") {
                if ($o5->amount_balance > $o3->amount) {
                    ...
                    $message = "Your wallet have been " . $o1->transfer_type . "ed with Rs. " . $o1->amount . " by Admin. Your new  balance is Rs. " . $o2->amount_balance;
                    // sendsms_3gsolutions($o2->mobile, $message);
                    sendmail($o2->email, " Wallet Update By Admin", "Dear " . $o2->name . ",<br/>" . $message . "<br/>Thanks you,<br/> " . $res_site[0]['site_name'] . " Team.");
                } else {
                ...
                // sendsms_3gsolutions($o2->mobile, $message);
                sendmail($o2->email, " Payment Request Rejected", "Dear " . $o2->name . ",<br/>" . $message . "<br/>Thanks you,<br/> " . $res_site[0]['site_name'] . " Team.");
            }
            $o3->decision_date = todaysDate();
