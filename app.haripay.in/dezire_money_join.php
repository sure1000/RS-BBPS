...
if ($_POST['imps_join_updte'] == '1') {
    ...
    if ($o2->api_id > 0) {
        ...
        if ($o2->is_active == "1") {
            $plaintext = '{"merchantUserID":"' . $o1->merchantUserID . '","senderCode":"' . $o1->senderCode . '","first_Name":"' . $o1->first_Name . '","last_Name":"' . $o1->last_Name . '","kyc_Flag":"' . $o1->kyc_Flag . '","mobileNo":"' . $o1->mobileNo . '","address":"' . $o1->address . '","cityName":"' . $o1->cityName . '","stateID":"' . $o1->stateID . '","pincode":"' . $o1->pincode . '","addressProofNo":"' . $o1->addressProofNo . '","addressProof":"' . $o1->addressProof . '","addressProofUrl":"' . $o1->addressProofUrl . '","idProofNo":"' . $o1->idProofNo . '","idProof":"' . $o1->idProof . '","idProofUrl":"' . $o1->idProofUrl . '"}';
            $cipher = "AES256";
