...
if ($_POST['updte'] == '1') {
    ...
    $o2->ipay_beneficiary_id = $_POST['ben_id'];
    if ($o1->ipay_user_id > 0 && $o2->ipay_beneficiary_id > 0) {
        ...
        $api_response = ipay_del_ben_otp($o1, $o2);
       // pt($api_response);
        if ($api_response['error'] == "0") {
            ...
            if ($api_response['statuscode'] == "TXN") {
                ...
                if ($api_response['data']['otp'] == "1") {
                    $result['error'] = "2";
                    $result['error_msg'] = "Otp Sent Successfully";
                    $result['benificiary_id_del'] =$o2->ipay_beneficiary_id ;
