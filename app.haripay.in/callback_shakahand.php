...
$o1->response_url = "" . $_SERVER['HTTP_HOST'] . "/callback_roundpay.php?status=".$_GET['status']."&mobile=".$_GET['mobile']."&amount=".$_GET['amount']."&tranid=".$_GET['rpid']."&agentid=".$_GET['agentid']."&liveid=".$_GET['opid']."&msg=".$_GET['msg'];
        if ($status == "Success") {
            $o1->status = "Success";
            $o1->opid = $OperatorRef;
